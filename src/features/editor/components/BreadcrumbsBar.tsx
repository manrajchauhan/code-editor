...
import { ChevronRight, Folder, Play, ChevronDown, Cpu } from 'lucide-react';
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1 px-2 py-0.5 rounded bg-accent/15 text-accent border border-accent/30 hover:bg-accent/25 transition-colors font-semibold cursor-pointer shrink-0"
