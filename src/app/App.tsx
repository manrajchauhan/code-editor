  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-bg-main font-sans">
      ...
      <header className="h-8 bg-bg-surface border-b border-border-subtle flex items-center justify-between px-3 text-xs text-text-muted select-none shrink-0">
        ...
        {/* Top-Right Developer Credit Badge */}
        <button
          type="button"
          onClick={() => setIsDevModalOpen(true)}
          className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-accent/10 border border-accent/20 hover:bg-accent/20 text-accent transition-colors cursor-pointer text-[11px] font-medium"
